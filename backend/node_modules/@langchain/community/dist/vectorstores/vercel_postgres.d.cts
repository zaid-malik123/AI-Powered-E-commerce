...
import * as _neondatabase_serverless0 from "@neondatabase/serverless";
...
declare class VercelPostgres extends VectorStore {
   ...
   */
  protected runInsertQuery(rows: (string | Record<string, any>)[][], useIdColumn: boolean): Promise<_neondatabase_serverless0.QueryResult<any>>;
  /**
